<form  role="form">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('name')}">
        ...
        <div class='input-icon'>
            ...
            <input type="name" class="form-control" name="name" v-model="registerForm.name" autofocus id="register_first_name" autocapitalize="words">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('username')}">
        ...
        <div class="input-icon">
            <i class="fa fa-user  fa-lg" aria-hidden="true"></i>
            <input type="text" class="form-control" name="username" v-model="registerForm.username" style='text-transform:lowercase' autocorrect="off" autocapitalize="none">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('phone')}">
        ...
        <div class="input-icon">
            ...
            <input type="tel" class="form-control" name="phone" v-model="registerForm.phone">
