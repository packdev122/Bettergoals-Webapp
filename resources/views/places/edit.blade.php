...
<div class="row">
    <div class="m-people-modify col-md-4 col-md-offset-4">
        <span class="m-back"><a href="/{{ Auth::user()->currentTeamName() }}/places"><i class="fa fa-chevron-left" aria-hidden="true"></i></a></span>
        ...
        @if ($organisation->id)
          <form action="{{route('places.update', $organisation->id)}}"  method="post" role="form" enctype="multipart/form-data" >
          {{ method_field('PUT') }}
        @else
            <form action="/places" role="form" enctype="multipart/form-data"  method="post">
        @endif
        {{ csrf_field() }}
        ...
        <div  class="row form-group {{ $errors->has('name') ? 'has-error' :'' }}" >
            ...
            <div class="col-xs-8">
                ...
                <input id="name"  type="text" class="form-control" name="name" value="{{ old('name', $organisation->name) }}" autocapitalize="words">
        ...
        <div class="row form-group {{ $errors->has('address') ? 'has-error' :'' }}" >
            ...
            <div class="col-xs-8">
                ...
                <input id="contact_address" onFocus="geolocate()" type="text" class="form-control" name="address" value="{{ old('address', $organisation->address) }}">
                <span class="help-block" >
        ...
        <div class="row form-group {{ $errors->has('phone') ? 'has-error' :'' }}" >
            ...
            <div class="col-xs-8">
                ...
                <input id="phone" type="tel" class="form-control" name="phone" value="{{ old('phone', $organisation->phone) }}">
                <span class="help-block">
                    {{$errors->first('phone')}}
                </span>
            </div>
        ...
        <div class="row form-group {{ $errors->has('website') ? 'has-error' :'' }}" >
            <div class="col-xs-4">
                <img src="/img/icon-website.svg" alt="Calendar" class="img-responsive top-space">
            </div>
            <div class="col-xs-8">
                <label class="control-label">Website</label>
                <input type="website" class="form-control" name="website" value="{{ old('website', $organisation->website) }}">
                <span class="help-block" >
