Vue.component('mobile-appointment', {
    props: ['appointment'],
    data() {
        return {
            photos: '',
    ...
    methods: {
        ...
        getPhotos() {
            axios.get('/api/photos/' + this.appointment.id)
                .then(response => {
        ...
        checkIn() {
            axios.post('/api/checkin/' + this.appointment.id)
                .then(response => {
        ...
        sendFile(fileData) {
            ...
            axios.post('/api/photo/' + this.appointment.id, formData)
            .then(
                photo => {
